# CURRENT-SCORE-PRIOR-001A known limitations

- This is a weak three-season Premier League home/away league mean, not current team, opponent,
  lineup, manager-regime or player strength.
...
- The current target-season rules source verifier retains its unrelated official-bootstrap
  freshness blocker.
- No raw or derived database persistence is implemented even though the approved rights would
