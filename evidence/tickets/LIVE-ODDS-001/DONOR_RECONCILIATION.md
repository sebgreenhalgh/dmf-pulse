...
| `parser.py` | Strict bounded parser; all non-H2H keys warned as unsupported | Treats configured totals as supported | Retain main parser architecture and source/semantic hashes; port configured-market recognition; make additive warning taxonomy explicit. |
