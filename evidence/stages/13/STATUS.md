...
merge. Integration gates pass.
Integration merge commit `6dc58db48415d831b37a10b423a9a555aa9fe833` was pushed normally and
local/remote equality was verified. Draft PR #12 is open, draft, unmerged and reported
`MERGEABLE`; GitHub reports `UNSTABLE` rather than a code-conflict state.
