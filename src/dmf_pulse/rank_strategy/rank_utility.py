...
def _require_common_projection_surface(
    ...
    return (
        ...
        {
            item.plan_id: item.scenario_score_hash
    ...
    if objective in {RankObjectiveMode.TARGET_RANK, RankObjectiveMode.RANK_PROTECTION}:
        ...
        return sum(
            (
                ...
                if item.rank <= target.target_rank
            ),
            0.0,
        )
    ...
    *,
    ...
    for candidate in ordered_candidates:
        ...
        metrics = RankPlanMetrics(
            ...
            expected_rank=None if distribution is None else distribution.expected_rank,
    ...
    if (
        ...
        < policy.minimum_target_probability_gain
    ):
    ...
    return value.model_copy(update={"decision_hash": semantic_sha256(payload)})
