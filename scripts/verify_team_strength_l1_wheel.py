...
import dmf_pulse
from dmf_pulse.private_v1.team_strength_live_authority import validate_l1_authority, APPROVAL, ATTESTATION, ConsumedL1ApprovalError
...
print(json.dumps({'installed_import': True, 'consumed_authority_blocked': consumed, 'closed_diagnostic': True, 'mutable_source_rejected': True,
