"""Create a capped public-safe ticket review archive with verified entry hashes."""
...
TICKET = "CURRENT-TEAM-STRENGTH-001A"
...
def build() -> dict[str, object]:
    ...
    for pattern in (
        "src/dmf_pulse/ingestion/openfootball/team_strength_*.py",
        "src/dmf_pulse/football_events/team_strength_*.py",
        "src/dmf_pulse/evaluation/team_strength_*.py",
        "tests/unit/**/test_team_strength*.py",
        "tests/unit/football_events/team_strength_support.py",
        "scripts/*team_strength*.py",
        f"tickets/{TICKET}/*",
